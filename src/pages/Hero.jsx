...
const Hero = () => {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden text-white rounded-3xl px-4 py-4">
      {/* BLURRED BACKGROUND */}
      <div
        ...
        <div className="w-full h-full flex flex-col justify-end">
          <div className="flex-1 flex flex-col items-center">
            ...
            <div className="leading-4 tracking-tight">
              <h2 className="uppercase text-center text-[0.85rem]">
                #1 most recommended
              </h2>
            ...
            <div className="flex items-center gap-4 mt-4">
              ...
              <img src="/images/global.webp" alt="" className="w-12" />
              <img src="/images/mask.webp" alt="" className="w-8" />
              <img src="/images/uk-social.webp" alt="" className="w-14" />
              <img src="/images/uk-content.webp" alt="" className="w-14" />
