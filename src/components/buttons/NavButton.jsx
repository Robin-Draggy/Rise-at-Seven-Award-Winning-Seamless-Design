      ...
      <div className="overflow-hidden h-12">
        ...
        <div ref={trackRef} className="flex flex-col items-center">
          ...
          <div className="h-12 px-4 flex items-center justify-center">
            <span className="flex items-center gap-1 capitalize font-medium whitespace-nowrap">
              {title}
          ...
          {/* BOTTOM */}
          <div className="h-12 px-4 flex items-center justify-center">
            <span className="flex items-center gap-2 capitalize font-medium whitespace-nowrap">
              {title}
